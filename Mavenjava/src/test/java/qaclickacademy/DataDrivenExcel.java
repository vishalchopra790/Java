...
public class DataDrivenExcel {
	...
	public ArrayList<String> getData(String testdata) throws IOException {
		...
		FileInputStream fis = new FileInputStream("C:\\Users\\X133477\\demodata.xlsx");
		...
		for (int i = 0; i < sheets; i++) {
			if (workbook.getSheetName(i).equalsIgnoreCase("demo1")) {
				...
				// identify TestCases column in the first row args
				...
				//// once column is identified then scan entire TestCases
				while (rows.hasNext()) {
					Row r = rows.next();
